...
def private_knn_deps_preload():
    ...
    # New dependencies.
    # TODO: Make this a http_archive once the ROOM code is public.
    if "sparse_linear_algebra" not in native.existing_rules():
        native.local_repository(
            name = "sparse_linear_algebra",
            path = "third_party/sparse_linear_algebra",
        )
