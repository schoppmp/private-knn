...
#include "private_knn/experiments/knn/two_party_phase/knn_config.hpp"
...
using private_knn::applications::knn::two_party_phase::KNNProtocol;
using private_knn::applications::knn::two_party_phase::MulType;
using private_knn::applications::knn::two_party_phase::PirType;
using private_knn::experiments::knn::two_party_phase::KNNConfig;
...
int main(int argc, const char *argv[]) {
  ...
  private_knn::experiments::knn::two_party_phase::KNNConfig conf;
  try {
